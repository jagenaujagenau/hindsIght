...
import com.warmly.watchrecorder.MainActivity
import com.warmly.watchrecorder.R
import com.warmly.watchrecorder.audio.ClipBuilder
import com.warmly.watchrecorder.audio.RingRecorder
import com.warmly.watchrecorder.data.Retention
import com.warmly.watchrecorder.data.RecorderSettings
import com.warmly.watchrecorder.sync.ClipOutbox
...
class RecorderService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.warmly.watchrecorder.START"
        const val ACTION_STOP = "com.warmly.watchrecorder.STOP"
        const val ACTION_SAVE = "com.warmly.watchrecorder.SAVE"
        const val ACTION_SET_RETENTION = "com.warmly.watchrecorder.SET_RETENTION"
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = getSystemService(PowerManager::class.java)
            .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "watchrecorder:capture")
